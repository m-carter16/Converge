...
namespace Converge.Controllers
{
    ...
    public class BuildingsV1Controller : Controller
    {
        ...
        [HttpGet]
        [Route("sortByName")]
        public async Task<ActionResult<BasicBuildingsResponse>> GetBuildingsByName(int? topCount = 200, int? skip = 0)
        {
        ...
        /// <param name="capacity">Whether to return places with capacity that are within a certain range</param>
