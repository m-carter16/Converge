    ...
    public class SyncService
    {
        ...
        private bool SyncGraphExchangePlace(GraphPlace graphPlace, ExchangePlace exchangePlace, out ListItem updatedPlace)
        {
            ...
            if (graphPlace.Address != null)
            {
                ...
                if (graphPlace.GeoCoordinates != null && graphPlace.GeoCoordinates.Latitude != null && graphPlace.GeoCoordinates.Longitude != null && string.IsNullOrEmpty(exchangePlace.GeoCoordinates))
                {
