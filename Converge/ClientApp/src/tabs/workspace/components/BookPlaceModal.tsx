...
type Props = {
  ...
  isFlexible?: boolean;
  getNewSettings?: (data: ConvergeSettings) => void;
};
          ...
          <Flex>
            <Checkbox
              ...
              onClick={() => {
                ...
                getNewSettings && getNewSettings(newSettings);
                meService.setSettings(newSettings)
                  ...
                  .finally(() => {
                    favoriteCheckBoxChecked
                      ? setFavoriteCheckBoxLabel(LABEL_ADD_FAVORITE)
                      : setFavoriteCheckBoxLabel(LABEL_REMOVE_FAVORITE);
                    setFavoriteCheckBoxChecked(!favoriteCheckBoxChecked);
                    setFavoriteCheckBoxLoading(false);
                  });
                logEvent(USER_INTERACTION, [
                  { name: UI_SECTION, value: UISections.BookPlaceModal },
