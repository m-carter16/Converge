...
const UPDATE_CAPACITY_FILTER = "UPDATE_CAPACITY_FILTER";
...
interface UpdateCapacityFilterAction {
  type: typeof UPDATE_CAPACITY_FILTER;
  payload: number;
}
...
type IContextModel = {
  ...
  updateCapacityFilter: (capacity: number) => void;
...
const PlaceContextProvider: React.FC = ({ children }) => {
  ...
  const updateCapacityFilter = (capacityFilter: number) => {
    dispatch({ type: UPDATE_CAPACITY_FILTER, payload: capacityFilter });
  };
