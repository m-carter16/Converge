    ...
    public class PlaceSyncJob : JobService
    {
        ...
        public async override Task DoWork(CancellationToken cancellationToken)
        {
            ...
            try
            {
                ...
                telemetryService.TrackEvent("PlaceSync: GetGraphPlacesToUpdate", "graphPlaces", graphPlaces);            
                ...
                telemetryService.TrackEvent("PlaceSync: GetPlacesToUpdate", "updatedPlaces", updatedSharePointPlaces);
