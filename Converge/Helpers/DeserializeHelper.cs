...
namespace Converge.Helpers
{
    public class DeserializeHelper
    {
        ...
        public static AdminSettings DeserializeAdminSettings(IDictionary<string, object> serializedSettings)
        {
            AdminSettings adminSettings = new AdminSettings
            {
                AppBannerMessage = GetProperty("AppBannerMessage", serializedSettings),
                AppBannerType = GetProperty("AppBannerType", serializedSettings),
                AppBannerExpiration = GetProperty("AppBannerExpiration", serializedSettings),
                WorkspaceEnabled = GetProperty("WorkSpaceEnabled", serializedSettings) == "True",
            };
