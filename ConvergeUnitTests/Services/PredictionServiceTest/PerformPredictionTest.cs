...
namespace ConvergeUnitTests.Services.PredictionServiceTest
{
    ...
    public class PerformPredictionTest
    {
        ...
        private readonly Mock<PlacesService> placesSvcMock;
        private readonly PredictionService predictionService;
        private readonly Mock<NotificationService> notificationSvcMock;
        private readonly NotificationService notificationService;

        private readonly int maxPredictionWindow = 14;
        ...
        public PerformPredictionTest()
        {
            ...
            notificationSvcMock = new Mock<NotificationService>();
            notificationService = notificationSvcMock.Object;
